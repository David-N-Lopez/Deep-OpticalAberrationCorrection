...
from int_version_cuda_init import *
import camera

cv2.namedWindow("SLM")

for batch in range(4000):
    filename = 'D:\\zernike\\zernike_coefficients\\Zernike_Coefficients_batch_' + str(batch) + '_int.npy'
    ...
    for i in range(0, 200):
        ...
        h_result = ((np.reshape(h_result,(sizeX, sizeY))) / 1000000) % 1
